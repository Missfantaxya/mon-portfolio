...
const Navigation = () => {
  return (
    <nav className="fixed p-4 left-0 flex justify-around items-center z-10 primary-bg portrait:w-screen portrait:min-h-max portrait:bottom-0 landscape:min-h-min landscape:h-dvh landscape:p-8 landscape:w-1/12 landscape:flex-col landscape:rounded-r-2xl">
